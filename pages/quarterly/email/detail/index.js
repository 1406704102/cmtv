...
Page({
    ...
    doLike() {
        ...
        wx.getStorage({
            ...
            success(res) {
                ...
                wx.navigateTo({
                    url: '/pages/my/login/login?type=0&share=share&id=' + that.data.email.id
                })
            }
        })
    ...
    onShareAppMessage: function () {
        ...
        return {
            ...
            path: 'pages/quarterly/email/detail/index?share=share&id=' + that.data.email.id
    ...
    onShareTimeline() {
        ...
        return {
            title: "树洞信件",
            query: 'timeline=1&share=share&id=' + that.data.email.id
        }
    },
})
