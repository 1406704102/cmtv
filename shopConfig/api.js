// 以下是业务服务器API地址
// 本机开发时使用
// var WxApiRoot = 'http://192.168.123.187:8180/wx/';
// 局域网测试使用
// var WxApiRoot = 'http://192.168.123.99:8180/wx/';
// 云平台部署时使用
// var WxApiRoot = 'http://122.51.199.160:8080/wx/';
// 云平台上线时使用
var WxApiRoot = 'https://applet.xmay.cc/wx/';
// var WxApiRoot = 'https://dowell.xmay.cc/wx/';
...
module.exports = {
  ...
  GoodsList: WxApiRoot + 'goods/list', //获得商品列表setvidoe
  ...
  cmbPay: WxApiRoot + 'order/cmb-pay-notify', // 修改订单状态为已成功
  ...
  liveList:WxApiRoot+'live/list',//直播列表
};
